...
SongInfo:
	...
	song_info "Bergentruckung", ORIGIN_UNDERTALE, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
	song_info "Asgore", ORIGIN_UNDERTALE, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
	...
	song_info "The Legend", ORIGIN_DELTARUNE, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
